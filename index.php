      ...
      <div class="row">
        <div class="col-12 titulo">
          ...
          <div class="texto-seta">
            ...
            <div class="setas">
              <button onclick="prevTime()"><img src="http://localhost/wpatratis/wp-content/uploads/2024/11/left.png" alt="Esquerda" /></button>
              <button onclick="nextTime()"><img src="http://localhost/wpatratis/wp-content/uploads/2024/11/right.png" alt="Direita" /></button>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="col-12 imagens">
          <div class="pessoas">
            <div class="owl-carousel owl-theme owl-time">
              ...
              <div class="imagem-container">
                <img src="http://localhost/wpatratis/wp-content/uploads/2024/11/albery.png" alt="Albery" style="align-self: start;"/>
                <div class="texto-sobre-imagem">
                  <h3>Albery Dias</h3>
              ...
              <div class="col imagensJornada d-flex justify-content-center">
                <div class="p-3">
                  <a href="/Startups.html" target="_parent">
                    <img src="http://localhost/wpatratis/wp-content/uploads/2024/11/amarelocard.png" alt="" class="image-zoom img-fluid"></a>
                </div>
              </div>
              <div class="col imagensJornada d-flex justify-content-center">
                <div class="p-3">
                  <img src="http://localhost/wpatratis/wp-content/uploads/2024/11/plantaocard.png" alt="" class="image-zoom img-fluid">
                </div>
              </div>
              <div class="col imagensJornada d-flex justify-content-center">
                <div class="p-3">
                  <img src="http://localhost/wpatratis/wp-content/uploads/2024/11/amarelocard.png" alt="" class="image-zoom img-fluid">
                </div>
              </div>
              <div class="col imagensJornada d-flex justify-content-center">
                <div class="p-3">
      ...
      <div class="row">
        ...
        <div class="col-lg-5 col-md-6">
          <div class="content-telefone">
            ...
            <path d="M3 1H7L9 6L6.5 7.5C7.57096 9.67153 9.32847 11.429 11.5 12.5L13 10L18 12V16C18 16.5304 17.7893 17.0391 17.4142 17.4142C17.0391 17.7893 16.5304 18 16 18C12.0993 17.763 8.42015 16.1065 5.65683 13.3432C2.8935 10.5798 1.23705 6.90074 1 3C1 2.46957 1.21071 1.96086 1.58579 1.58579C1.96086 1.21071 2.46957 1 3 1Z" stroke="#520660" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
            </svg>
            ...
            <path d="M1.72915 4.33333L16.9297 19.9542M1.72915 4.33333C2.2947 3.65369 3.13942 3.22222 4.08316 3.22222H9.22177M1.72915 4.33333C1.27429 4.87996 1 5.58712 1 6.35948V17.8627C1 19.5954 2.38038 21 4.08316 21H15.3881C17.0909 21 18.4713 19.5954 18.4713 17.8627V13.1569M9.22177 13.1569L2.54158 19.9542M16.5057 4.55556V4.48872M20 4.47826C20 6.7971 16.5057 9.88889 16.5057 9.88889C16.5057 9.88889 13.0115 6.7971 13.0115 4.47826C13.0115 2.55727 14.5759 1 16.5057 1C18.4356 1 20 2.55727 20 4.47826Z" stroke="#520660" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
            </svg>  
              <a href="localbiolabs">
